...
python3 $PYTHON_SCRIPT --raw-jet-data-dir $RAW_DATA_DIR --min-data-seed $MIN_SEED --max-data-seed $MAX_SEED --data-year $DATA_YEAR --energy-gev $DATA_ENERGY_GEV --image-dir $OUT_JET_IMAGE_DIR --save-dir $SAVE_DATA_DIR --num-epochs $NUM_EPOCHS
